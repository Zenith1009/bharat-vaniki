...
export default function EnhancedSections() {
  ...
  return (
    <div className="relative">
      ...
      {/* About Indian Forests Section */}
      <section ref={aboutRef} className="about w-full h-screen bg-gray-400 flex justify-center items-center sticky top-0 z-10">
        ...
        />
        <div
          className="content absolute top-[15%] sm:top-[10%] md:top-[20%] w-full sm:w-[90%] md:w-[80%] max-w-[1140px] px-4 sm:px-6 md:px-8 lg:px-0 box-border text-white translate-y-12 blur-[20px] opacity-0 z-[200]"
          style={isAboutIntersecting ? { animation: "showContent 1s .1s linear 1 forwards" } : {}}
        >
          <div className="author font-bold tracking-wider uppercase text-xs sm:text-sm md:text-base">
            Welcome
          </div>
          <div className="title text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold leading-tight uppercase">
            About Indian{" "}
          </div>
          <div className="topic text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold text-orange-600 leading-tight uppercase">
            Forests
          </div>
          <div className="des text-sm sm:text-base md:text-lg lg:text-xl mt-3 sm:mt-4 leading-relaxed">
          ...
          <div className="mt-4 sm:mt-6">
            <Link href="/destinations">
              <Button className="bg-green-600 hover:bg-green-700 text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 z-[300] transition-all duration-300 hover:scale-105">
                Explore More
              </Button>
            </Link>
          </div>
      ...
      <section ref={tripsRef} className="trips w-full h-screen bg-black flex justify-center items-center sticky top-0 z-20">
        <div className="hide vignette absolute z-[100] w-full h-full top-0 left-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0)_65%,_rgba(0,0,0,0.7))]"></div>
        <video
          autoPlay
          loop
        ...
        <div
          className="content absolute top-[15%] sm:top-[10%] md:top-[20%] w-full sm:w-[90%] md:w-[80%] max-w-[1140px] px-4 sm:px-6 md:px-8 lg:px-0 box-border text-white opacity-0 blur-[20px] z-[200]"
      ...
      <section ref={galleryRef} className="gallery w-full h-screen bg-gray-600 flex justify-center items-center sticky top-0 z-30">
        <div className="hide vignette absolute z-[100] w-full h-full top-0 left-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0)_65%,_rgba(0,0,0,0.7))]"></div>
        <Image
        ...
        >
          <div className="author font-bold tracking-wider uppercase text-xs sm:text-sm md:text-base">Explore</div>
          <div className="title text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold leading-tight uppercase">
            the forest
          </div>
          <div className="topic text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold text-orange-600 leading-tight uppercase">
      ...
      <section ref={conservationRef} className="w-full h-screen bg-gray-600 flex justify-center items-center sticky top-0 z-40 overflow-hidden">
        <div className="hide vignette absolute z-[100] w-full h-full top-0 left-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0)_65%,_rgba(0,0,0,0.7))]"></div>
        ...
        >
          <div className="author font-bold tracking-wider uppercase text-xs sm:text-sm md:text-base">protect</div>
          <div className="title text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold leading-tight uppercase">
            conservation
          </div>
          <div className="topic text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold text-orange-600 leading-tight uppercase">
